...
function Minimise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 1495, 0, 45)}):Play()
	TweenService:Create(Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 1495, 0, 45)}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	Main.Size = UDim2.new(0, 1450, 0, 260)
	Main.Visible = true
